...
// All Dexie access for the qada ledger (ADR-0010). Append-only: debts and payments are events,
// never edits, so the remaining balance is always a fold over history and nothing can be silently
// rewritten. The table already exists in schema version 1 — this slice adds no migration.
...
export const qadaRepository: QadaRepository = {
  listQadaEvents,
  addQadaDebt,
  payQadaPrayer,
}
